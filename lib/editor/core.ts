import type { BundledLanguage, BundledTheme, Highlighter, HighlighterCore } from "shiki";
...
interface ShikiCodeFactory {
	create(domElement: HTMLElement, highlighter: HighlighterCore, options: InitOptions): ShikiCode;
